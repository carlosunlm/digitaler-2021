...
DROP DATABASE if exists digitalers;
CREATE DATABASE IF NOT EXISTS digitalers;
USE digitalers;
...
#cupones
insert into CUPONES (nombre,codigo,fecha_vigencia_desde,fecha_vigencia_hasta, descuento) values('BIENVENIDA','001',curdate(), date_add(curdate(), interval 10 day),50);
