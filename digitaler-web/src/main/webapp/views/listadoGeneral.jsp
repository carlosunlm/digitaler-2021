		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-md-12 col-lg-2 mt-1">
					<h3>Filtrar:</h3>
					<form class="form-inline" action="<%=request.getContextPath()%>/controllers/BuscarArticuloServlet" method="post">
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		        <form id="eliminarForm" action="<%=request.getContextPath()%>/controllers/EliminarProductoServlet">
		      		<input name="<%=ViewKeyEnums.ID_PRODUCTO.getViewKey() %>" type="hidden" id="idProductoEliminar">
